 ...
 * @return void
 */
function romano_register_block_patterns() {
	...
	register_block_pattern_category(
		'images',
		array( 'label' => esc_html__( 'Images', 'romano' ) )
	);

}
add_action( 'init', 'romano_register_block_patterns', 9 );
 ...
 * @return void
 */
function romano_unregister_patterns() {
	unregister_block_pattern( 'core/query-small-posts' );
	unregister_block_pattern( 'core/query-large-title-posts' );
	unregister_block_pattern( 'core/query-offset-posts' );
	unregister_block_pattern_category( 'header' );
}
add_action( 'init', 'romano_unregister_patterns', 10 );
